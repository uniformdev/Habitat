...
$ScVariableName = "sourceFolder"
$SrcSourceFolderPath = "C:\inetpub\wwwroot\App_Data\Habitat"
$WebsiteRootPath = "$PSScriptRoot\.docker\files"
& $PSScriptRoot\setup\AfterInstall.ps1 -WebsiteRootPath $WebsiteRootPath -SrcSourceFolderPath $SrcSourceFolderPath -ScVariableName $ScVariableName -Force
...
if ($Detach) {
    ...
    $KeepAliveUrl= "http://localhost:44100/sitecore/service/keepalive.aspx"
